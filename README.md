...
```sh
curl --fail --silent --show-error https://diverge.up.railway.app/api/scan
curl --fail --silent --show-error https://diverge.up.railway.app/api/scan/OPENAI
curl --fail --silent --show-error https://diverge.up.railway.app/api/scan/XAI
```
